...
class Float16Module(MegatronModule):
    ...
    def __init__(self, config: TransformerConfig, module: torch.nn.Module):
        ...
        # Snapshot FP32 params marked with _keep_fp32 before precision conversion (miles dsv4:
        # attn_sink, compressor.ape, mHC hc_* params must stay fp32 for correctness/asserts).
        fp32_params = {}
