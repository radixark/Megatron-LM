...
from miles_plugins.true_on_policy.contracts import get_true_on_policy_contract
...
from miles_plugins.true_on_policy.matmul import _sglang_row_parallel_matmul, sglang_reference_matmul
...
def test_legacy_sglang_backend_imports_match_true_on_policy_namespace():
    ...
    from miles_plugins.true_on_policy import (
        attention_fa3,
        bias_dropout,
        cp_layout,
        linear,
    ...
    from miles_plugins.true_on_policy import matmul, sglang_backend
